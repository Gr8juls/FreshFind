...
export default function LoyaltyDashboard() {
  ...
  return (
    <>
      <div className="w-full max-w-4xl mx-auto p-6 sm:p-7 rounded-3xl bg-white dark:bg-gradient-to-br dark:from-slate-900 dark:via-slate-900 dark:to-emerald-950/60 border border-slate-200 dark:border-slate-800 shadow-xl transition-colors duration-200">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-6">
          ...
          <div className="flex items-center space-x-2">
            <div className="flex items-center gap-2 px-3.5 py-1.5 bg-brand-500/10 rounded-full border border-brand-500/30">
              ...
              <span className="text-xs font-bold text-brand-600 dark:text-brand-300">{badgeTier}</span>
            </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3.5">
          ...
          <div 
            onClick={() => setIsModalOpen(true)}
            className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-950/80 border border-slate-200 dark:border-slate-800/80 hover:border-brand-500/40 flex flex-col items-center justify-center text-center transition cursor-pointer group shadow-sm"
          >
